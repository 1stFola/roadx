...
class TrackerPassenger {
  ...
  factory TrackerPassenger.fromJson(Map<String, dynamic> json) {
  ...
  static List<TrackerPassenger> fromJsonList(List<dynamic> json) =>
      json.map((i) => TrackerPassenger.fromJson(i)).toList();
